...
def pytest_addoption(parser: pytest.Parser):
    ...
    parser.addoption("--homebrew", action="store_true", default=False, help="Use the Homebrew (macOS/Linuxbrew) deployment, building LRR from the formula in --build. Requires --build.")
    ...
    parser.addoption("--cache-backend", action="store", default="valkey", choices=["redis", "valkey", "valkey8"], help="Cache/DB backend for container and Homebrew deployments. Default: valkey.")
